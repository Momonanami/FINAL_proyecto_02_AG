...
public class Empleados4 extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empleados4);
        ...
        btnDespues.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), Empleados5.class);
                startActivityForResult(intent, 0);
            }
        });
    ...
    private void visualizar(long id)
    {
        ...
        Intent i = new Intent(Empleados4.this, EmpleadosFormulario.class);
