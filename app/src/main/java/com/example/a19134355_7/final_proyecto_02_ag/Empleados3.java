...
public class Empleados3 extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empleados3);
        ...
        btnAntes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), Empleados2.class);
        ...
        btnDespues.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), Empleados4.class);
                startActivityForResult(intent, 0);
            }
        });
    ...
    private void visualizar(long id)
    {
        ...
        Intent i = new Intent(Empleados3.this, EmpleadosFormulario.class);
