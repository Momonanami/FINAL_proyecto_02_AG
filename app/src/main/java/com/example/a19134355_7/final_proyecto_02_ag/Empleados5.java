...
public class Empleados5 extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empleados5);
        ...
        btnDespues.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), Empleados6.class);
                startActivityForResult(intent, 0);
            }
        });
    ...
    private void visualizar(long id)
    {
        ...
        Intent i = new Intent(Empleados5.this, EmpleadosFormulario.class);
